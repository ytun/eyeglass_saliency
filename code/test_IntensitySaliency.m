...
for index=69
    ...
    index
    filename='balloons.png'; %faces.png
   % CurrentFrame=mat2gray(imArr(:,:,index));
    CurrentFrame=rgb2gray(imread(fullfile('/Users/ytun/Google Drive/CS670Project/Matlab_code/bak_dec_1/img_new',filename)));
...
%     
%     
         [finalSal,im_size] = getSaliency(CurrentFrame,plotOn);
% 
figure;
...
%     [max_x, max_y] = getMaxPosition(finalSal,bestSigma,round(gaze_est));
    ...
    C1=imfuse(1.5*CurrentFrame,C,'blend','Scaling','joint');
        imshow(C1);
